...
//    node --max_old_space_size=4096 |
    shell.exec('ls -l -R \"' + searchPath + '\" | grep -v .lnk | tr -s " "', {silent: true}, function (err, resault){
        ...
        console.log("Scan Stopped After: "+minutes+":"+seconds+" minutes");
...
*/
        ...
        for (dirIndex = 1; dirIndex < dirArr.length; dirIndex++) {
            console.log("dirIndex="+dirIndex+"/"+(dirArr.length-1));
            filesArr = dirArr[dirIndex].split("\n");
...
searchTheHardDrive("C:/Users/Dor", mongo.writeToDB, mongo.disconnect);
//Program Files (x86)
